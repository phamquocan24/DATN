...
BEGIN
    ...
    INSERT INTO recruiter_profiles (user_id, company_id, position, department)
    VALUES 
        (recruiter1_id, company1_id, 'Senior HR Manager', 'Human Resources'),
        (recruiter2_id, company2_id, 'Technical Recruiter', 'Engineering'),
        (recruiter3_id, company3_id, 'Talent Acquisition Lead', 'HR & Talent')
    ON CONFLICT (user_id) DO NOTHING;
    ...
    INSERT INTO jobs (
        ...
        (
            gen_random_uuid(),
            (SELECT profile_id FROM recruiter_profiles WHERE company_id = company1_id LIMIT 1),
            company1_id,
        ...
        (
            gen_random_uuid(),
            (SELECT profile_id FROM recruiter_profiles WHERE company_id = company2_id LIMIT 1),
            company2_id,
        ...
        (
            gen_random_uuid(),
            (SELECT profile_id FROM recruiter_profiles WHERE company_id = company3_id LIMIT 1),
            company3_id,
...
INSERT INTO skills (skill_name, category, description) VALUES
    ('React.js', 'Frontend', 'Frontend JavaScript library for building user interfaces'),
    ...
    ('React Native', 'Mobile', 'Framework for building native mobile apps using React'),
    ...
    ('TypeScript', 'Programming', 'Strongly typed programming language built on JavaScript'),
