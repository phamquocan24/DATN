    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      {showSuccessPopup && (
        <div className="fixed inset-0 z-60 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            <div className="fixed inset-0 bg-black bg-opacity-25" onClick={handleSuccessPopupClose} />
            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md">
              <div className="bg-white px-6 py-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Đơn ứng tuyển của bạn đã được gửi thành công đến <span className="font-medium">{job.company}</span>. 
                ...
                <div className="flex flex-col space-y-3">
                  <button
                    ...
                    className="w-full bg-[#007BFF] text-white px-4 py-2 rounded-lg hover:bg-[#0056b3] transition-colors font-medium"
                  >
                    Đóng
                  </button>
                  <button
