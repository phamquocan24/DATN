    ...
    <>
      ...
      >
        ...
        <div className="flex h-[550px]">
          ...
          {/* Right side - Form */}
          <div className="w-full p-6 pt-4 lg:pt-6 lg:w-3/5 rounded-2xl lg:rounded-l-none">
              ...
              <>
                ...
                >
                  ...
                  <span className="text-gray-700 font-medium text-sm">
                    {currentMode === 'signup' ? 'Sign Up with Google' : 'Login with Google'}
                  </span>
                </button>
                ...
                <div className="relative mb-3">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-2 bg-white text-gray-500">
                      Or {currentMode === 'signup' ? 'sign up' : 'login'} with email
                    </span>
                  </div>
                </div>
            ...
            {currentMode === 'signup' && (
              <div>
                      <label htmlFor="confirmPassword" className="block text-xs font-bold text-gray-700 mb-1 text-left">
                  Confirm Password
                </label>
                <div className="relative">
                  <input
                  ...
                  {currentMode === 'login' && (
                    <div className="flex items-center justify-between">
                      ...
                      <button type="button" onClick={() => switchMode('forgot-password')} className="text-xs text-[#007BFF] hover:underline">Forgot password?</button>
                    </div>
                  )}
              ...
              disabled={loading}
                  ...
                  >
                    {loading ? (
                      ...
                      currentMode === 'signup' ? 'Continue' : 'Login'
              )}
            </button>
          </form>
    ...
    {showOTPModal && (
      <OTPVerifyModal
        ...
        onVerified={(data) => {
          ...
          if (pendingUserData) {
            onAuthSuccess(pendingUserData.user, pendingUserData.token);
            resetForm();
            onClose();
          }
        }}
