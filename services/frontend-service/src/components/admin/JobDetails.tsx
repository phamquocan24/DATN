...
import { FiArrowLeft, FiEdit, FiCheckCircle, FiHeart, FiUmbrella, FiTrendingUp, FiUsers, FiHome, FiTruck, FiGift } from 'react-icons/fi';

const JobDetails: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    ...
    return (
        <div className="text-left">
            ...
            <div className="flex items-center justify-between gap-4 p-4 border rounded-lg mb-8">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-purple-500 text-white flex items-center justify-center rounded-lg text-2xl font-bold">S</div>
