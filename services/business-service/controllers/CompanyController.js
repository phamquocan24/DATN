...
router.post('/', authenticateToken, requireRole(['RECRUITER', 'RECRUITER']), async (req, res) => {
  try {
 ...
 */
// Update company
router.put('/:company_id', authenticateToken, requireRole(['RECRUITER', 'RECRUITER']), async (req, res) => {
  try {
    const { company_id } = req.params;
 ...
 */
// Delete company
router.delete('/:company_id', authenticateToken, requireRole(['RECRUITER', 'RECRUITER']), async (req, res) => {
  try {
    const { company_id } = req.params;
...
router.get('/:company_id/recruiters', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), async (req, res) => {
  try {
    const { company_id } = req.params;
...
router.get('/:company_id/stats', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), async (req, res) => {
  try {
    const { company_id } = req.params;
