...
class TestController {
  ...
  async getAllTests(req, res) {
    try {
      ...
      } else if (req.user.role === 'RECRUITER' || req.user.role === 'RECRUITER') {
...
router.get('/job/:jobId', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), testController.getTestsByJob.bind(testController));
router.get('/', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), testController.getAllTests.bind(testController)); // Get all tests
router.get('/:id', authenticateToken, testController.getTestById.bind(testController));
router.post('/', authenticateToken, requireRole(['RECRUITER', 'RECRUITER']), testController.createTest.bind(testController));
...
router.post('/:id/assign', authenticateToken, requireRole(['RECRUITER', 'RECRUITER']), testController.assignTest.bind(testController));
...
router.get('/:id/stats', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), testController.getTestStats.bind(testController));
router.get('/:id/results', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), testController.getTestResults.bind(testController));
