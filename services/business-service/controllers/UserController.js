...
class UserController {
  ...
  // Note: register method removed - use /api/v1/auth/register endpoint in modules/auth.js instead
...
// Define routes
// Note: register endpoint moved to /api/v1/auth/register in modules/auth.js
