...
const updateApplicationStatusSchema = Joi.object({
  current_status: Joi.string().valid('APPLIED', 'SUBMITTED', 'REVIEWING', 'SHORTLISTED', 'INTERVIEWED', 'OFFERED', 'HIRED', 'REJECTED', 'WITHDRAWN').required(),
...
const searchApplicationsSchema = Joi.object({
  ...
  current_status: Joi.alternatives().try(
    Joi.string().valid('APPLIED', 'SUBMITTED', 'REVIEWING', 'SHORTLISTED', 'INTERVIEWED', 'OFFERED', 'HIRED', 'REJECTED', 'WITHDRAWN'),
    Joi.array().items(Joi.string().valid('APPLIED', 'SUBMITTED', 'REVIEWING', 'SHORTLISTED', 'INTERVIEWED', 'OFFERED', 'HIRED', 'REJECTED', 'WITHDRAWN'))
  ).optional(),
...
router.get('/stats', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.getApplicationStats.bind(applicationController));
router.get('/statistics', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.getApplicationStats.bind(applicationController));
router.get('/scheduled-interviews', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.getScheduledInterviews.bind(applicationController));
...
router.get('/job/:jobId', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.getJobApplications.bind(applicationController));

// Bulk operations
router.post('/bulk-update', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.bulkUpdateApplications.bind(applicationController));
...
router.put('/:id/status', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.updateApplicationStatus.bind(applicationController));
...
router.post('/:id/shortlist', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.shortlistCandidate.bind(applicationController));
router.post('/:id/reject', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.rejectCandidate.bind(applicationController));
router.post('/:id/schedule-interview', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.scheduleInterview.bind(applicationController));
router.put('/interviews/:historyId/update', authenticateToken, requireRole(['RECRUITER', 'RECRUITER', 'ADMIN']), applicationController.updateInterview.bind(applicationController));
