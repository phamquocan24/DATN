...
const HrDashboard: React.FC<HrDashboardProps> = ({ notifOpen, hasUnread, toggleNotif, setHasUnread, setNotifOpen }) => {
  ...
  const stats = [
    { label: 'Review new candidates', value: 76, color: 'bg-blue-500', path: '#' },
    { label: 'Schedule for today', value: 3, color: 'bg-green-500', path: '#' },
    { label: 'Messages received', value: 24, color: 'bg-cyan-500', path: '#' },
  ];

  const hrJobStatsData = [
    { day: 'Mon', view: 20, applied: 40 },
    { day: 'Tue', view: 25, applied: 55 },
    { day: 'Wed', view: 30, applied: 45 },
    { day: 'Thu', view: 20, applied: 65 },
    { day: 'Fri', view: 25, applied: 50 },
    { day: 'Sat', view: 30, applied: 70 },
    { day: 'Sun', view: 25, applied: 60 },
  ];
