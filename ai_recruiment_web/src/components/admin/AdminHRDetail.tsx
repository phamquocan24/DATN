...
const AdminHRDetail: React.FC = () => {
  ...
  return (
    <AdminLayout>
      <div className="p-8 bg-gray-50" style={{fontFamily:'ABeeZee, sans-serif'}}>
        {/* Back + Title */}
        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 bg-white border border-gray-200 rounded-lg p-6 mb-8">
          <div className="relative">
            <img src={hrDetails.companyLogo} alt={hrDetails.companyName} className="w-24 h-24 object-contain" />
          ...
          <div className="flex-1 text-left">
            ...
            <a href={hrDetails.companyInfo.website} className="text-[#007BFF] text-sm hover:underline mb-4">{hrDetails.companyInfo.website}</a>

            {/* Metrics */}
            <div className="flex items-center justify-between text-sm mt-6">
              {[
                { icon: <TbFlame />, label: "Founded", value: "July 31, 2011" },
                { icon: <PiUsersThree />, label: "Employees", value: hrDetails.companyInfo.size },
                { icon: <IoLocationOutline />, label: "Location", value: "20 countries" },
                { icon: <BsBuildings />, label: "Industry", value: hrDetails.companyInfo.industry }
              ].map((metric, index) => (
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <a href={`tel:${hrDetails.phone}`} className="flex items-center gap-2 px-3 py-1 border border-gray-300 rounded-md hover:bg-gray-50"><FaPhoneAlt className="text-gray-500"/> {hrDetails.phone}</a>
          </div>
        </div>
