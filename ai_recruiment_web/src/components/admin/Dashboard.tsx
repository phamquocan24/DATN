...
const Dashboard: React.FC = () => {
  const stats = [
    { label: 'New Jobs to Review', value: 50, color: 'bg-blue-500', path: '/admin/job-listings' },
    { label: 'Violated Accounts', value: 10, color: 'bg-orange-500', path: '/admin/accounts' },
    { label: 'New Feedback', value: 5, color: 'bg-green-500', path: '/admin/feedback' },
  ];

  const jobStatsData = [
    { day: 'Mon', approved: 102, pending: 89, spam: 37 },
    { day: 'Tue', approved: 114, pending: 25, spam: 17 },
    { day: 'Wed', approved: 48, pending: 54, spam: 54 },
    { day: 'Thu', approved: 168, pending: 35, spam: 17 },
    { day: 'Fri', approved: 92, pending: 56, spam: 45 },
    { day: 'Sat', approved: 20.5, pending: 20.5, spam: 42 },
    { day: 'Sun', approved: 81, pending: 11, spam: 20 },
  ];

  const updates = [
    { title: 'New Employer', applied: 5, capacity: 10, icon: User1Icon, path: '/admin/accounts' },
    { title: 'New Candidate', applied: 5, capacity: 10, icon: User2Icon, path: '/admin/accounts' },
    { title: 'New Spam Post', applied: 5, capacity: 10, icon: GlassIcon, path: '/admin/job-listings' },
    { title: 'New Feedback & Issues', applied: 5, capacity: 10, icon: FBIcon, path: '/admin/feedback' },
  ];
